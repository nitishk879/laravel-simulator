...
@section('content')
    <div class="container-fluid" id="xLungFormData">
        <form method="post" action="{{ route('xlung-pcv') }}" class="row" id="xLungForm">
            @csrf
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <div class="pt-2 text-center">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <button id="btn" onclick="updateArrayPcv();" class="btn btn-sm btn-outline-success">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body" id="xLung">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 input-group input-group-sm mb-2">
                                <div class="input-group-prepend">
                                    <span class="input-group-text text-black-50" id="deltaP">DeltaP</span>
                                </div><input type="hidden" name="vlume" value="500">
                                <input type="number" id="deltaP" name="deltaP" class="form-control" min="1" max="999" step="1" value="{{ $xlung['deltaP'] ?? old('deltaP') }}" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                            </div>
                            <div class="col-md-6 input-group input-group-sm mb-2">
                                <div class="input-group-prepend">
...
@section('scripts')
    ...
    <script src="{{ asset('js/pcv.js') }}"></script>
